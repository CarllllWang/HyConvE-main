...
class HyConvE(BaseClass):
    ...
    def __init__(self, dataset, emb_dim, emb_dim1):
        ...
        self.pos_embeddings = nn.Embedding(self.dataset.arity_lst[-1], self.emb_dim)  # position embedding
        # self.pos_emb = PositionalEncoding(self.emb_dim, device=self.dataset.device)



        self.conv_layer_2 = nn.Conv3d(in_channels=1, out_channels=6, kernel_size=(1, 1, 3))
        self.conv_layer_3 = nn.Conv3d(in_channels=1, out_channels=6, kernel_size=(1, 1, 4))
        self.conv_layer_4 = nn.Conv3d(in_channels=1, out_channels=6, kernel_size=(1, 1, 5))
        self.conv_layer_5 = nn.Conv3d(in_channels=1, out_channels=6, kernel_size=(1, 1, 6))
        self.conv_layer_6 = nn.Conv3d(in_channels=1, out_channels=6, kernel_size=(1, 1, 7))
        self.conv_layer_7 = nn.Conv3d(in_channels=1, out_channels=6, kernel_size=(1, 1, 8))
        self.conv_layer_8 = nn.Conv3d(in_channels=1, out_channels=6, kernel_size=(1, 1, 9))
        self.conv_layer_9 = nn.Conv3d(in_channels=1, out_channels=6, kernel_size=(1, 1, 10))
        ...
        self.pool = torch.nn.MaxPool3d((2, 2, 1))
        ...
        self.conv_size = (self.emb_dim1 * self.emb_dim2) * 6 // 4
    ...
    def forward(self, batch, labels):
        ...
        if batch.shape[1] == 3:
            ...
            x2 = self.conv1d_process((r, e1, e2))
            x = x1 + x2
            # x = x2
            x = self.nonlinear(x)
            x = self.bn4(x)
        ...
        if batch.shape[1] == 4:
            ...
            x2 = self.conv1d_process((r, e1, e2, e3))
            x = x1 + x2
            # x = x2
            x = self.nonlinear(x)
            x = self.bn4(x)
        ...
        if batch.shape[1] == 5:
            ...
            x2 = self.conv1d_process((r, e1, e2, e3, e4))
            x = x1 + x2
            # x = x2
            x = self.nonlinear(x)
            x = self.bn4(x)
        ...
        if batch.shape[1] == 6:
            ...
            x2 = self.conv1d_process((r, e1, e2, e3, e4, e5))
            x = x1 + x2
            # x = x2
            x = self.nonlinear(x)
            x = self.bn4(x)
        ...
        if batch.shape[1] == 7:
            ...
            x2 = self.conv1d_process((r, e1, e2, e3, e4, e5, e6))
            x = x1 + x2
            # x = x2
            x = self.nonlinear(x)
            x = self.bn4(x)
        ...
        if batch.shape[1] == 8:
            ...
            x2 = self.conv1d_process((r, e1, e2, e3, e4, e5, e6, e7))
            x = x1 + x2
            # x = x2
            x = self.nonlinear(x)
            x = self.bn4(x)
        ...
        if batch.shape[1] == 9:
            ...
            x2 = self.conv1d_process((r, e1, e2, e3, e4, e5, e6, e7, e8))
            x = x1 + x2
            # x = x2
            x = self.nonlinear(x)
            x = self.bn4(x)
        ...
        if batch.shape[1] == 10:
            ...
            x2 = self.conv1d_process((r, e1, e2, e3, e4, e5, e6, e7, e8, e9))
            x = x1 + x2
            # x = x2
            x = self.nonlinear(x)
            x = self.bn4(x)
